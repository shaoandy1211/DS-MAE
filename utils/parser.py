...
def get_args():
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='test pretrained model with svm')
    parser.add_argument(
        '--vis',
        action='store_true',
        default=False,
    ...
    # if args.test and args.task is None:
    #     raise ValueError(
    #         'task shouldnt be None while test mode')

    if args.finetune_model and args.ckpts is None:
        print(
            'training from scratch')
        
    # if args.finetune_model and args.task is None:
    #     raise ValueError(
    #         'task shouldnt be None while finetune mode')
